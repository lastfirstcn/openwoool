...
function LotteryServlet.getByIngot( roleSID, payRet, money, itemId, itemCount, callBackContext )
	...
	if payRet == 0 then
		...
		if objs.objid == 2151 or objs.objid == 3001 or objs.objid == 3002 or objs.objid == 2998 or objs.objid == 2999 or objs.objid == 3000 or objs.objid == 2152 or objs.objid == 1197 then
