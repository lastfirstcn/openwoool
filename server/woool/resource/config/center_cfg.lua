...
center_config = 
{
	[1] = {addr = "10.8.8.199",	port = 20007, game_name = "cqsj",
		game_id = 1009, url = "http://center.cqsj.sdo.com:8080/api.php", app_secret = "5c7f4ea46f0d1c6c5c30693f24016374"},			--传世中心服务器
...
mysql_config = 
{	
	[1] = {name = "backtool", user = "root", password = "kuniushareycg", host = "127.0.0.1", port = 3306},			--传世	
	[2] = {name = "backtool", user = "root", password = "kuniushareycg", host = "127.0.0.1", port = 3306},			--内部
}
