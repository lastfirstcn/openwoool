...
function addNetLoading(sendNetMsg, removeNetMsg, isReconnect, time, delaytime)
	cclog("addNetLoading wait for msg:"..tostring(removeNetMsg))
...
function startTimerAction(parent, delay, isLoop, callFunc)
	...
	if isLoop == true then
		...
		--cclog("startTimerAction........schedule.............")
	else
		action = performWithDelay(parent,callFunc,delay)
		--cclog("startTimerAction........performWithDelay.............")
	end
	return action
end
...
function createMonsterEffect(monster, effect_file, frame_count, time, loop)
	cclog("[createMonsterEffect] called start. file = %s, count = %d, time = %d, loop = %d.", effect_file, frame_count, time, loop)
