...
function LotteryLayer:updateLuckUI()
	cclog("self.luck = "..tostring(self.luck))
	cclog("self.luckId = "..tostring(self.luckId))
	cclog("self.luckCount = "..tostring(self.luckCount))
	cclog("self.luckFreshCount = "..tostring(self.luckFreshCount))
	cclog("self.luckTime = "..tostring(self.luckTime))
