...
function SecondaryPassword.validPassword()          -- only valid password here
    ...
    createSprite(bg,"res/jieyi/titlebg.png",cc.p(bgWidth/2,bgHeight-36))
    createLabel(bg,game.getStrByKey("secondarypass_inputtitle"),cc.p(249,306),cc.p(0.5,0.5),22,nil,nil,nil,MColor.lable_yellow)
    createLabel(bg,game.getStrByKey("secondarypass_inputremind"),cc.p(249,100),cc.p(0.5,0.5),20,nil,nil,nil,MColor.alarm_red)

    forgetRemindLabel = createLabel(bg, "",cc.p(249,140),cc.p(0.5,0.5),20,nil,nil,nil,MColor.alarm_red)
    ...
    local editePwd = createEditBox(editePwdBg, nil ,cc.p(130, 22) ,cc.size(250,194),nil , 22,game.getStrByKey("sp_psssFormat"))    -- last param placeholder
...
function SecondaryPassword.modifyPassword()
    ...
    local downDis = 30
    local leftDis = 20
    createLabel(bg,game.getStrByKey("secondarypass_modifyTitle"),cc.p(266-leftDis,306),cc.p(0.5,0.5),22,nil,nil,nil,MColor.lable_yellow)
    ...
    local editePwdOld = createEditBox(editePwdBg, nil ,cc.p(2, 22) ,cc.size(270,47), nil, 22,"")    -- last param placeholder
    ...
    local editePwdNew1 = createEditBox(editePwdBgNew, nil ,cc.p(2, 22) ,cc.size(270,47), nil, 22,game.getStrByKey("sp_psssFormat"))    -- last param placeholder
    ...
    local editePwdNew2 = createEditBox(editePwdBgNew2, nil ,cc.p(2, 22) ,cc.size(270,47), nil, 22,"")    -- last param placeholder
    ...
    local btn = createMenuItem(bg,"res/component/button/50.png",cc.p(160-leftDis,65-downDis),noCallBack)
    createLabel(btn,game.getStrByKey("cancel"),cc.p(71,31),cc.p(0.5,0.5),22,nil,nil,nil,MColor.lable_yellow)
    btn = createMenuItem(bg,"res/component/button/50.png",cc.p(369-leftDis,65-downDis),yesCallBack)
...
function SecondaryPassword.settingPassword()
    ...
    local downDis = 30
    local leftDis = 20
    createLabel(bg,game.getStrByKey("sp_settingPassword"),cc.p(246,306),cc.p(0.5,0.5),22,nil,nil,nil,MColor.lable_yellow)
    ...
    local editePwdNew1 = createEditBox(editePwdBgNew, nil ,cc.p(2, 22) ,cc.size(270,47), nil, 22,"")    -- last param placeholder
    editePwdNew1:setAnchorPoint(cc.p(0, 0.5))
    editePwdNew1:setInputFlag(cc.EDITBOX_INPUT_FLAG_PASSWORD)
    editePwdNew1:setReturnType(cc.KEYBOARD_RETURNTYPE_DONE)
    ...
    createLabel(bg,game.getStrByKey("sp_psssFormat"),cc.p(245,100),cc.p(0.5,0.5),20,nil,nil,nil,MColor.alarm_red)
