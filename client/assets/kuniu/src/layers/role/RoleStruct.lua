...
setAttr = function(self, attrId, objId, buff, isMe, callback)
	...
	-- 着装包裹
	if attrId >= PLAYER_EQUIP_WEAPON and attrId <= PLAYER_EQUIP_MEDAL or attrId == PLAYER_EQUIP_FLAG or attrId == PLAYER_EQUIP_SHIELD or attrId == SPECIAL_RING_BASE or attrId == SPECIAL_RING_WEDDING or attrId == SPECIAL_RING_PROTECT  or attrId == SPECIAL_RING_KILL or attrId == SPECIAL_RING_KING or attrId == SPECIAL_RING_HOLY or attrId == SPECIAL_RING_IMMORTAL then
