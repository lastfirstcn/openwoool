...
--	cclog("[FBDefensePrincess:ctor] called.")
...
--	cclog("[FBDefensePrincess:startDialog] called. roleid = %d.", roleid)
end
...
--	cclog("[FBDefensePrincess:closeDialogText] called.")
end
...
--	cclog("[FBDefensePrincess:viewTouchEnded] x = %d, y = %d.", curOffset.x, curOffset.y)
...
--	end
	...
	cclog("FBShowName itemName = %s, itemId = %d.", itemName, itemID)
...
--	cclog("[FBDefensePrincess:closeDialogPrize] called.")
end
...
function FBDefensePrincess:sendSelectPrize(index)
	...
	cclog("[FBDefensePrincess:sendSelectPrize] called. roleid = %d, index = %d.", roleid, index)
end
...
function FBDefensePrincess:goNextLevel()
	...
	cclog("[FBDefensePrincess:goNextLevel] called. levelID = %d.", levelID)
	self:closeDialogPrize()
end

function FBDefensePrincess:goExit()
	cclog("[FBDefensePrincess:goExit] called.")
