...
function tutoAddTip(layer, touchNodeList, tutoInfo, noTouchNode)
	--cclog("add Tip nodeTag = "..tutoInfo.q_controls[tutoInfo.q_step].touchNode)
...
function tutoSetAdaptionPosition(node)
	...
	cclog("test x="..worldPos.x)
	cclog("test y="..worldPos.y)
	...
	cclog("worldPos x="..worldPos.x)
	cclog("worldPos y="..worldPos.y)
	return worldPos
end
...
-- 	cclog("retPos x="..retPos.x)
-- 	cclog("retPos y="..retPos.y)
-- 	return retPos
-- end

function tutoSetState(tutoInfo, state,finshType)
	cclog("tutoSetState")
	cclog("q_id = "..tutoInfo.q_id)
	cclog("state = "..state)
	...
	if state == TUTO_STATE_FINISH then
		...
		-- end
		cclog("send finish q_id = "..tutoInfo.q_id)
		...
		if G_MAINSCENE and G_MAINSCENE.addHangUpCheck then
			--cclog("wangning 11111111111111111111111111111111111111111111111")
...
function addTeamShow(params)
	cclog("addTeamShow 1111111111111111111111111111")
...
function openTaskMenu()
	cclog("openTaskMenu 1111111111111111111111111111")
