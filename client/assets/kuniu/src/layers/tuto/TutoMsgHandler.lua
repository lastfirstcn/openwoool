...
local onRecvShopData = function(buffer)
	...
	--  	end)
	-- else
	-- 	-- cclog("1111111111111111111111111111111111111")
	-- 	-- startTimerAction(G_MAINSCENE.baseNode, 2, false, function() 
	-- 	-- 	cclog("333333333333333333333333333333333333333")
	-- 	-- 	dump(G_MAINSCENE)
	-- 	-- 	if G_NFTRIGGER_NODE then
	-- 	-- 		cclog("22222222222222222222222222222222222222222")
