...
function StoryGongSha:updateState()
	...
	local switch = {
        function()
            ...
            startTimerAction(self, 0.05, false, function()
                cclog("假人更新 updateState.....5555555555555555...............")
                G_ROLE_MAIN:upOrDownRide(false)
            end )

            cclog("假人更新 updateState.....333333...............")

            startTimerAction(self, 0.4, false, function()

                       cclog("假人更新 updateState.....444444...............")
            ...
            startTimerAction(self, 2.0, false, function()
                self:updateState()
                cclog("假人更新 updateState.....666666...............")
            end)
        end
        ,
