...
function StoryNode:updateState()  
    cclog("StoryNode:updateState state = "..self.state)
    --self:stopAllActions()
...
function StoryNode:addAudioEffect()
    ...
    self.audioEffectAction = startTimerAction(self, 0.3, true, function() 
        ...
        cclog("1 musicVolume = "..musicVolume)
        cclog("1 effectVolume = "..effectVolume)
        ...
        cclog("2 musicVolume = "..musicVolume)
        cclog("2 effectVolume = "..effectVolume)
