...
function FactionUpdateLayer:updateInfo() 
	cclog("FactionUpdateLayer:updateInfo")
...
function FactionUpdateLayer:networkHander(buff, msgid)
	local switch = {
		...
		[FACTION_SC_UPLEVEL_RET] = function() 
			cclog("get FACTION_SC_UPLEVEL_RET"..msgid)
		...
		[FACTIONCOPY_SC_GET_PASS_TIME_RET] = function()
			...
			cclog("[FACTIONCOPY_SC_GET_PASS_TIME_RET] In FactionUpdateLayer. time = %s, copyid = %s, setcount = %s.", bossTime, copyId, copySetCount)
		end,
	}
...
function FactionUpdateLayer:getUpdateData(updateType, level, region)
	cclog("FactionUpdateLayer:getUpdateData")
	cclog("updateType = "..updateType)
	cclog("level = "..level)
	cclog("region = "..region)
