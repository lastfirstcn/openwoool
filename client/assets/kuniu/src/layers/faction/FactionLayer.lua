...
function FactionLayer:networkHander(buff,msgid)
	local switch = {
		[FACTION_SC_GETFACTIONINFO_RET] = function()
			cclog("get FACTION_SC_GETFACTIONINFO_RET"..msgid)
		...
		-- 	cclog("FACTION_SC_GETALLFACTION_RET")
		-- 	removeFromParent(self)
		-- end
		-- ,
		[FACTION_SC_FRESHUI] = function()
			cclog("FACTION_SC_FRESHUI")
