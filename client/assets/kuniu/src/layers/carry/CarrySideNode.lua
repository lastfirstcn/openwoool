...
function CarrySideNode:changeRankMode()
	cclog("CarrySideNode:changeRankMode")
	...
	-- 	self.reward = nil
	-- end
	cclog("CarrySideNode:changeRankMode end")
end

function CarrySideNode:getReward()
	cclog("CarrySideNode:getReward")
	...
	cclog("CarrySideNode:getReward end")
end
...
function CarrySideNode:setFinishMode(isFinish)
	cclog("CarrySideNode:setFinishMode")
	...
	cclog("CarrySideNode:setFinishMode end")
end

function CarrySideNode:reloadData()
	cclog("CarrySideNode:reloadData")
	...
	cclog("CarrySideNode:reloadData end")
end

function CarrySideNode:createRewardList()
	cclog("createRewardList")
...
function CarrySideNode:networkHander(buff,msgid)
	local switch = {
		...
		-- 	cclog("get ENVOY_SC_MONSTER_UPDATE")
		-- 	local floor = buff:popChar()
		-- 	local monsterType = buff:popChar()
		-- 	local monsterNum = buff:popInt()
		-- 	cclog("floor = "..floor)
		-- 	cclog("monsterType = "..monsterType)
		-- 	cclog("monsterNum = "..monsterNum)
