...
eSpecialRingWedding = 16	-- 婚戒
eSpecialRingProtect = 17	-- 护戒
eSpecialRingKill = 18	-- 秒戒
eShield = 19 --盾牌
eSpecialRingKing = 20 --王戒
eSpecialRingHoly = 21 --圣戒
...
local tEquipId = {
	...
	[eFlag] = Mconvertor.eFlag,
	[eSpecialRingBase] = Mconvertor.eSpecialRingBase,
	[eSpecialRingWedding] = Mconvertor.eSpecialRingWedding,
	[eSpecialRingProtect] = Mconvertor.eSpecialRingProtect,
	[eSpecialRingKill] = Mconvertor.eSpecialRingKill,
	[eShield] = Mconvertor.eShield,
	[eSpecialRingKing] = Mconvertor.eSpecialRingKing,
	[eSpecialRingHoly] = Mconvertor.eSpecialRingHoly,
	[eSpecialRingYaqiang] = Mconvertor.eSpecialRingYaqiang,
}
...
local tDressId = {
	...
	[Mconvertor.eFlag] = eFlag,
	[Mconvertor.eSpecialRingBase] = eSpecialRingBase,
	[Mconvertor.eSpecialRingWedding] = eSpecialRingWedding,
	[Mconvertor.eSpecialRingProtect] = eSpecialRingProtect,
	[Mconvertor.eSpecialRingKill] = eSpecialRingKill,
	[Mconvertor.eShield] = eShield,
	[Mconvertor.eSpecialRingKing] = eSpecialRingKing,
	[Mconvertor.eSpecialRingHoly] = eSpecialRingHoly,
