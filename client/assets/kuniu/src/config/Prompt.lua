local Items = {
	...
	{q_MarkID = 49,q_Promptobject = '沙城争霸战规则1',q_contentdescription1 = '开服7天后，每周日19：00-20：00',},
	...
	{q_MarkID = 52,q_Promptobject = '沙城争霸战规则4',q_contentdescription1 = '1. 获胜行会会长：圣天级武器、非绑定元宝88W、城主称号！',q_contentdescription2 = '2. 获胜行会成员：行会贡献+200、经验+200万',q_contentdescription3 = '3. 参与奖励：行会贡献+50、经验+50万',},
