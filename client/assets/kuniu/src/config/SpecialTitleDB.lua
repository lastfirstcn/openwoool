local Items = {
	...
	{q_id = 1,q_lv = 40,q_exp = 5,q_school = 4,q_name = '战将',q_color = 'white',},
	{q_id = 2,q_lv = 41,q_exp = 5,q_school = 4,q_name = '战狂',q_color = 'white',},
	{q_id = 3,q_lv = 42,q_exp = 5,q_school = 4,q_name = '武狂',q_color = 'white',},
	{q_id = 4,q_lv = 43,q_exp = 5,q_school = 4,q_name = '武宗',q_color = 'white',},
	{q_id = 5,q_lv = 44,q_exp = 5,q_school = 4,q_name = '武尊',q_color = 'white',},
	{q_id = 6,q_lv = 45,q_exp = 5,q_school = 4,q_name = '战圣',q_color = 'white',},
	{q_id = 7,q_lv = 46,q_exp = 5,q_school = 4,q_name = '天武者',q_color = 'white',},
	{q_id = 8,q_lv = 47,q_exp = 5,q_school = 4,q_name = '天武战士',q_color = 'white',},
	{q_id = 9,q_lv = 48,q_exp = 5,q_school = 4,q_name = '天武战将',q_color = 'white',},
	{q_id = 10,q_lv = 49,q_exp = 5,q_school = 4,q_name = '天武战狂',q_color = 'white',},
	{q_id = 11,q_lv = 50,q_exp = 5,q_school = 4,q_name = '天武王',q_color = 'green',},
	{q_id = 12,q_lv = 51,q_exp = 5,q_school = 4,q_name = '天武战神',q_color = 'green',},
	{q_id = 13,q_lv = 51,q_exp = 55,q_school = 4,q_name = '天武宗师',q_color = 'green',},
	{q_id = 14,q_lv = 52,q_exp = 5,q_school = 4,q_name = '天武战圣',q_color = 'green',},
	{q_id = 15,q_lv = 52,q_exp = 55,q_school = 4,q_name = '神武者',q_color = 'green',},
	{q_id = 16,q_lv = 53,q_exp = 5,q_school = 4,q_name = '神武战士',q_color = 'green',},
	{q_id = 17,q_lv = 53,q_exp = 55,q_school = 4,q_name = '神武战将',q_color = 'green',},
	{q_id = 18,q_lv = 54,q_exp = 5,q_school = 4,q_name = '神武战狂',q_color = 'green',},
	{q_id = 19,q_lv = 54,q_exp = 55,q_school = 4,q_name = '神武王',q_color = 'green',},
	{q_id = 20,q_lv = 55,q_exp = 5,q_school = 4,q_name = '神武战神',q_color = 'green',},
	{q_id = 21,q_lv = 55,q_exp = 55,q_school = 4,q_name = '神武宗师',q_color = 'green',},
	{q_id = 22,q_lv = 56,q_exp = 5,q_school = 4,q_name = '神武战圣',q_color = 'green',},
	{q_id = 23,q_lv = 56,q_exp = 55,q_school = 4,q_name = '圣武者',q_color = 'green',},
	{q_id = 24,q_lv = 57,q_exp = 5,q_school = 4,q_name = '圣武战士',q_color = 'green',},
	{q_id = 25,q_lv = 57,q_exp = 55,q_school = 4,q_name = '圣武战将',q_color = 'green',},
	{q_id = 26,q_lv = 58,q_exp = 5,q_school = 4,q_name = '圣武战狂',q_color = 'green',},
	{q_id = 27,q_lv = 58,q_exp = 55,q_school = 4,q_name = '圣武王',q_color = 'green',},
	{q_id = 28,q_lv = 59,q_exp = 5,q_school = 4,q_name = '圣武战神',q_color = 'green',},
	{q_id = 29,q_lv = 59,q_exp = 55,q_school = 4,q_name = '圣武宗师',q_color = 'green',},
	{q_id = 30,q_lv = 60,q_exp = 5,q_school = 4,q_name = '圣武战圣',q_color = 'blue',},
	{q_id = 31,q_lv = 60,q_exp = 55,q_school = 4,q_name = '威武极天战士',q_color = 'blue',},
	{q_id = 32,q_lv = 61,q_exp = 5,q_school = 4,q_name = '威武极天战将',q_color = 'blue',},
	{q_id = 33,q_lv = 61,q_exp = 55,q_school = 4,q_name = '威武极天战狂',q_color = 'blue',},
	{q_id = 34,q_lv = 62,q_exp = 5,q_school = 4,q_name = '威武极天战神',q_color = 'blue',},
	{q_id = 35,q_lv = 62,q_exp = 55,q_school = 4,q_name = '威武极天宗师',q_color = 'blue',},
	{q_id = 36,q_lv = 63,q_exp = 5,q_school = 4,q_name = '威武极天战圣',q_color = 'blue',},
	{q_id = 37,q_lv = 63,q_exp = 55,q_school = 4,q_name = '洪武行天战圣',q_color = 'blue',},
	{q_id = 38,q_lv = 64,q_exp = 5,q_school = 4,q_name = '雄武驰天战圣',q_color = 'blue',},
	{q_id = 39,q_lv = 64,q_exp = 55,q_school = 4,q_name = '尊武凌天战圣',q_color = 'blue',},
	{q_id = 40,q_lv = 65,q_exp = 5,q_school = 4,q_name = '神威亢天战圣',q_color = 'blue',},
	{q_id = 41,q_lv = 65,q_exp = 55,q_school = 4,q_name = '至尊傲天战圣',q_color = 'blue',},
	{q_id = 42,q_lv = 66,q_exp = 5,q_school = 4,q_name = '至尊傲天战神',q_color = 'blue',},
	{q_id = 43,q_lv = 66,q_exp = 55,q_school = 4,q_name = '均天鬼煞战狂',q_color = 'blue',},
	{q_id = 44,q_lv = 67,q_exp = 5,q_school = 4,q_name = '均天覆海战将',q_color = 'blue',},
	{q_id = 45,q_lv = 67,q_exp = 40,q_school = 4,q_name = '均天移山战君',q_color = 'blue',},
	{q_id = 46,q_lv = 67,q_exp = 70,q_school = 4,q_name = '均天混天战仙',q_color = 'blue',},
	{q_id = 47,q_lv = 68,q_exp = 5,q_school = 4,q_name = '均天斗天战神',q_color = 'blue',},
	{q_id = 48,q_lv = 68,q_exp = 40,q_school = 4,q_name = '均天九霄战圣',q_color = 'blue',},
	{q_id = 49,q_lv = 68,q_exp = 70,q_school = 4,q_name = '苍天鬼煞战狂',q_color = 'blue',},
	{q_id = 50,q_lv = 69,q_exp = 5,q_school = 4,q_name = '苍天覆海战将',q_color = 'blue',},
	{q_id = 51,q_lv = 69,q_exp = 40,q_school = 4,q_name = '苍天移山战君',q_color = 'blue',},
	{q_id = 52,q_lv = 69,q_exp = 70,q_school = 4,q_name = '苍天混天战仙',q_color = 'blue',},
	{q_id = 53,q_lv = 70,q_exp = 5,q_school = 4,q_name = '苍天斗天战神',q_color = 'purple',},
	{q_id = 54,q_lv = 70,q_exp = 30,q_school = 4,q_name = '苍天九霄战圣',q_color = 'purple',},
	{q_id = 55,q_lv = 70,q_exp = 55,q_school = 4,q_name = '变天鬼煞战狂',q_color = 'purple',},
	{q_id = 56,q_lv = 70,q_exp = 80,q_school = 4,q_name = '变天覆海战将',q_color = 'purple',},
};
