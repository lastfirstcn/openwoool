...
function globalInit(reset)
    ...
    G_SpecialRingPrivilegeInfo = false
    G_SpecialRingPrivilegeInfo2 = false
    G_SpecialRingPrivilegeInfo3 = false
    G_SpecialRingPrivilegeInfo4 = false
    G_SpecialRingPrivilegePosList = {}
